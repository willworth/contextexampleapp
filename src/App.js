    ...
    return (
      <div className="person2">
        ...
        <MyContext.Consumer>
          {context => (
            <Fragment>
              <p>Number of free chairs= {context.state.numberOfFreeChairs}</p>
      ...
      <MyProvider>
        <div className="App">
          ...
          <p>
            ...
            <a href="https://github.com/willworth/contextexampleapp">github</a>,
            or see a working copy on{" "}
            <a href="https://codesandbox.io/s/github/willworth/contextexampleapp">
              {" "}
              codesandbox
            </a>{" "}
            .
          ...
          <p>
            There are two child components. The first, Person, is receiving
            state via props, the traditional way:
          </p>

          <Person office={this.state.office} />
          <p>
            The second, Person2, is receiving state via context. This could be
            an arbitrary number of levels deep and still work the same way. No
